...
This is a copy of the code at https://www.ladybug.tools/ladybug/docs/_modules/ladybug/psychrometrics.html
Source: https://github.com/ladybug-tools/ladybug/blob/master/ladybug/psychrometrics.py
Originally developed by Ladybug Tools under AGPL-3.0 license
"""
